...
define gui.about = _p("""
Jeux crée exclusivement à l'aide de technologies de l'inteligence artificiel pour prouver que si on veut vraiment faire un projet sans avois les "skills" pour pouvoir le faire, quand on veut on le peut ^^.
""")
...
define config.save_directory = "JNS-1700130958"
